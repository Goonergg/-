package com.leduoduo.health.Utils;
...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "xbuxGjFtS69Ibas4y5q07EUYOemJWJtsemRkHLKx";
    private static final String SECRETKEY = "ZuOxJhBzOmP97ZWXX8bGlKw3qv916wgQZy_OCyRa";
    private static final String BUCKET = "gg0505";
    public static final String DOMAIN= "http://r8841moyw.bkt.clouddn.com/";

    public static void main(String[] args) {
//        uploadFile("C:\\Users\\Administrator\\Pictures\\Saved Pictures\\1111.png","dd2.jpg");
    ...
    private static BucketManager getBucketManager(){
        ...
        Auth auth = Auth.create(ACCESSKEY, SECRETKEY);
        // 创建操作某个仓库的管理器
        return new BucketManager(auth, new Configuration(Zone.autoZone()));
    }
